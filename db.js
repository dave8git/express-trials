const db = {
    testimonials: [
        ...
        { id: 3, author: 'Dave Pol', text: 'Awesome! I\'ll be back' },
        { id: 4, author: 'Mike Doe', text: 'What a great place!' },
        { id: 5, author: 'Logan Paul', text: 'Cool stuff here!' },
        { id: 6, author: 'Larry White', text: 'Clean and tidy.' },
        { id: 7, author: 'Michael Jackson', text: 'Bille Jean would stay here!' },
        { id: 8, author: 'Donald Trump', text: 'A bit too poor for me, but ok.' },
        { id: 9, author: 'Harry Potter', text: 'Pure Magic!' },
        { id: 10, author: 'Johnny Depp', text: 'Would not come here with Amber! Awesome place!' },  
    ],
    concerts: [
